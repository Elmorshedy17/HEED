    ...
    String textFieldHint() {
      if (ModalRoute.of(context).settings.name == '/clinicsScreen') {
        ...
        return AppLocalizations.of(context)
            .translate('SearchMedicalAdvice_str');
      } else if (ModalRoute.of(context).settings.name ==
                ...
                onSubmitted: (value) async {
                  ...
                  if (searchQuery.isNotEmpty) {
                    if (ModalRoute.of(context).settings.name !=
                        ...
                        ModalRoute.of(context).settings.name !=
                            '/clinicSectionDetailsScreen') {
                      await ApiService.getOurClinicsModel(
                      ...
                      Navigator.of(context).pushNamed("/ourClinicsScreen",
                          arguments: OurClinicsScreenArguments(
                              isQueryEmptyFromOutside: false));
                            ...
                            onPressed: () {
                              ...
                              setState(() {
                                ...
                                locator<HistorySearchBloc>()
                                    .inQuery
                                    .add(searchQuery);
                                locator<MedicalSearchBloc>()
                                    .inQuery
                                    .add(searchQuery);
                                locator<DoctorsSearchBloc>()
                                    .inQuery
                                    .add(searchQuery);
                              });
